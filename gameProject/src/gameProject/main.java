...
public class main {
	...
	public static void main(String[] args) {
		...
		gamerService.register(new Gamer(1, "FÝLÝZ BÝRCE ", "ÇETÝN", "BÝRCE98 ", "63190268094", 1998));

		gamerService.informationUpdate(new Gamer(1, "FÝLÝZ BÝRCE", "ÇETÝN", "BÝRCE98 ", "63190268094", 1998));
		
		gamerService.deleteRecord(new Gamer(1, "FÝLÝZ BÝRCE", "ÇETÝN", "BÝRCE98", "63190268094", 1998));
